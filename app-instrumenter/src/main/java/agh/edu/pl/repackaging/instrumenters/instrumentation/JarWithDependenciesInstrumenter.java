...
public class JarWithDependenciesInstrumenter {
  ...
  public void instrumentJarWithDependencies() {
    ...
    try {
      process =
          InstrumentationConstants.getInstrumentationProcess(
                  ...
                  temporaryFolders.getJARWithInstrumentedDependenciesPackage(),
    ...
    File instrumentedMainFile =
        new File(
            String.valueOf(temporaryFolders.getJARWithInstrumentedDependenciesPackage()),
            mainFileName);
    ...
    final File outFile =
        new File(String.valueOf(temporaryFolders.getInstrumentedJARPackage()), mainFileName);
