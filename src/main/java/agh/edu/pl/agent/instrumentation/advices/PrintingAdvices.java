...
public class PrintingAdvices {
  ...
  static long enter(@Advice.Origin String origin, @Advice.Origin("#t #m") String detailedOrigin) {
  ...
  static void exit(@Advice.Origin String origin, @Advice.Origin("#t #m") String detailedOrigin) {
